...
def  main():
  ...
  installer = "\installer\LeifsFirstIPlugEffect Installer.exe"
   
  if demo:
    installer = "\installer\LeifsFirstIPlugEffect Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\LeifsFirstIPlugEffect manual.pdf" 
  ]
  ...
  ZIPNAME = "LeifsFirstIPlugEffect-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "LeifsFirstIPlugEffect-v" + FULLVERSIONSTR + "-win-demo.zip"
