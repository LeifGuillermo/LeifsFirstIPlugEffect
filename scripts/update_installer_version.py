...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=LeifsFirstIPlugEffect Demo Installer\n"
      else:
        line="OutputBaseFilename=LeifsFirstIPlugEffect Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the LeifsFirstIPlugEffect Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the LeifsFirstIPlugEffect installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=LeifsFirstIPlugEffect Demo installer\n"
     else:
       line="SetupWindowTitle=LeifsFirstIPlugEffect installer\n"
