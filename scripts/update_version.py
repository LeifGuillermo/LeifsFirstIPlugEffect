...
def main():
  ...
  plistpath = scriptpath + "/resources/LeifsFirstIPlugEffect-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LeifsFirstIPlugEffect-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LeifsFirstIPlugEffect-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LeifsFirstIPlugEffect-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LeifsFirstIPlugEffect-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/LeifsFirstIPlugEffect.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/LeifsFirstIPlugEffect.iss",inplace=1):
